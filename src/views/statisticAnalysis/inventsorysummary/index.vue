    ...
    <div class="filter-container prodtotal">
      <el-form :inline="true" label-width="70px">
        <el-form-item label="商品分类" class="item-r">
          <el-select v-model="queryParams.classId" style="width: 200px" clearable filterable placeholder="请输入关键词"
            :loading="loading3">
            <el-option v-for="item in cbpaList" :key="item.cbpa01" :label="item.cbpa07 + ' [' + item.cbpa11 + ']'"
              :value="item.cbpa01"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="品牌" class="item-r">
          <el-select v-model="queryParams.cbpb10" style="width: 200px" clearable filterable placeholder="请输入关键词"
            :loading="loading2">
        ...
        <el-form-item label="商品" class="item-r">
          <el-select @change="getGoods" :remote-method="getGoods" v-el-select-loadmore="getGoodsloadmore"
            v-model="queryParams.cbpb01" style="width: 200px" clearable filterable remote placeholder="请输入关键词">
        ...
        <el-form-item style="margin: 0px -10px 1px 1px">
          <el-button v-hasPermi="['countQuery:inventsorysummaryquery:list']" class="filter-item" type="primary"
          ...
          <el-button v-hasPermi="['countQuery:inventsorysummaryquery:export']" class="filter-item" type="primary"
