    ...
    <div class="selectContentBox" v-if="showBox">
      <div class="contentArea">
        ...
        <div class="flex flex-wrap flex-around" style="padding: 15px 0;border-bottom: 1px solid #e5e5e5;">
          <div class="cursor" v-if="curIndex == DateList.length - 1" style="width: 15%;"><i style="opacity: 0.5" class="el-icon-d-arrow-left"></i></div>
          <div class="cursor" v-else @click="reduceYear" style="width: 15%;"><i  class="el-icon-d-arrow-left"></i></div>
          <div>{{OneY}}年</div>
          <div class="cursor t-r" v-if="curIndex == 0" style="width: 15%;"><i style="opacity: 0.5" class="el-icon-d-arrow-right"></i></div>
          <div class="cursor t-r" v-else @click="addYear" style="width: 15%;"><i class="el-icon-d-arrow-right"></i></div>
        </div>
        <!-- 月份 -->
      ...
      <div class="buttonBox t-r">
        <el-button class="buttonStyle" style="margin-left: 10px" size="mini" type="primary" plain @click.stop="handleSubmit">确定</el-button>
  ...
  export default {
    ...
    methods:{
      ...
      handleSubmit(){
        ...
        this.$emit('selected', _this.optTimes)
        // 关闭弹框
        _this.showBox = false
