  ...
  <div>
    <section ref="print" class="recordImg" id="printRecord">
      ...
      <div style="width:97%; margin-left: 2%; margin-top: 1%;">
        <el-table border :header-cell-style="headClasspwbitd" :row-style="{height: '3px'}"
          :cell-style="{padding: '2px'}" :data="userList" :default-sort="{ prop: 'name', order: 'descending' }"
        ...
        <pagination v-if="false" v-show="total > 0" :total="total" :page.sync="queryParams.pageNum"
          :limit.sync="queryParams.pageSize" @pagination="getList" :page-sizes="[10,15,20,50,500]" class="pagintotal" />
