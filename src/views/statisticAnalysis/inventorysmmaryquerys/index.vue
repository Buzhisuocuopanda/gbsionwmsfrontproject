      ...
      <el-form :inline="true">
        <el-form-item label="日期">
          <el-date-picker size="mini" v-model="dateRange" type="daterange" :picker-options="pickerOptions"
            popper-class="elDatePicker" value-format="yyyy-MM-dd" range-separator="至" start-placeholder="单据日期起始"
            end-placeholder="单据日期截止" align="right">
          </el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="仓库" class="item-r">
          <el-select v-model="queryParams.cbwa01" filterable remote reserve-keyword placeholder="请输入关键词"
            :loading="loading3">
        ...
        <el-form-item style="margin: -13px -10px 1px 1px">
          <el-button v-hasPermi="['countQuery:inventorysmmaryquerys:list']" class="filter-item" type="primary"
          ...
          <el-button v-hasPermi="['countQuery:inventorysmmaryquerys:export']" class="filter-item" type="primary"
            v-on:click="exprotData()" style="margin-bottom:0;margin-left: 1em">导出</el-button>
        </el-form-item>
      </el-form>
      <el-table :row-style="{ height: '3px' }" :header-cell-style="headClasspw" :cell-style="{ padding: '2px' }"
        height="460" :data="inwuquList" element-loading-text="Loading。。。" width="100%;" v-loading="loading" border fit
        ...
        <el-table-column label="SKU" align="left" prop="cbpb12" min-width="300px;" />
