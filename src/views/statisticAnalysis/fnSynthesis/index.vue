  ...
  <div class="app-container">
    <div class="filter-container prodtotal">
      <el-form :inline="true" style="height:auto;">
        ...
        <el-form-item>
          <el-button v-hasPermi="['query:fnSynthesis:list']" class="filter-item" type="primary" icon="el-icon-search"
            style="margin-bottom:0;margin-left: 2em" @click="handleQuery">搜索</el-button>
          <el-button v-hasPermi="['query:fnSynthesis:list']" class="filter-item" type="primary"
            style="margin-bottom:0;margin-left: 1em" @click="resetQuery">重置</el-button>
          <el-button v-hasPermi="['query:fnSynthesis:export']" class="filter-item" type="primary"
      ...
      <el-table :header-cell-style="headClasspwfnsyns" :data="inwuquList" :row-style="{ height: '3px' }"
        ...
        <el-table-column fixed label="入库时间" align="left" :formatter="formatDate" header-align="center" prop="inWhTime"
          min-width="100px;" />
