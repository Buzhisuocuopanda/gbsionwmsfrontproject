    ...
    <div class="filter-container skuDisbut">
      <el-form :inline="true" label-width="120px">
        ...
        <el-form-item style="margin: 0px -10px 1px 1px">
          <el-button v-hasPermi="['system:saleOrderSku:list']" class="filter-item" type="primary" icon="el-icon-search"
            style="margin-bottom:0;margin-left: 2em" @click="onSearch">搜索
          </el-button>
          <el-button v-hasPermi="['system:saleOrderSku:list']" class="filter-item" type="primary"
      ...
      <el-table :data="skuList" :row-style="{height: '3px'}" :cell-style="{padding: '2px'}"
        element-loading-text="Loading。。。" width="100%;" height="490" border fit highlight-current-row
        ...
        <el-table-column label="商品" align="left" prop="goodsMsg" min-width="680px;" />
        ...
        <el-table-column label="操作" min-width="200px;">
          <template slot-scope="scope">
            ...
            <el-button class="caozuoxiangqengsku" v-hasPermi="['system:updateGjQty:save']" v-if="scope.row.id==editId"
              icon="el-icon-edit" plain size="mini" type="text" @click="updateDetail(scope.row)">保存</el-button>
            <el-button class="caozuoxiangqengsku" v-else icon="el-icon-edit" size="mini" type="text"
              @click="mdfDetail(scope.row)">库存分配</el-button>
            <el-button class="caozuoxiangqengsku" icon="el-icon-s-order" size="mini" @click="mdfDetailQx(scope.row)"
