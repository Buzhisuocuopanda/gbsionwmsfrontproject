<template>
    <div>
        <el-form ref="form2" :model="form2" label-width="30%" :rules="rules" style="">
            <div class="chuangjiancaigous">仓库盘点汇总表</div>
            <el-row>
                <el-col :span="7">
            ...
            <el-row>
                <el-col style="margin-left: 3%;" :span="5">
                    <el-form-item label="调出仓库:" prop="cbpc100">
                ...
                <el-col style="margin-left: 2%;" :span="5">
                    <el-form-item label="结算货币:" prop="cbpc16">
                        <el-select v-model="form2.cbpc16" placeholder="" style="width:100%; border: solid #eee thin;">
                ...
                <el-col style="margin-left: 2%;" :span="6">
                    <el-form-item label="关联订单/提货单:" prop="cbpc10">
                        <el-input v-model="form2.cbpc10" placeholder="" maxlength="30"
                            style="width:100%;border:solid #eee thin" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="false">
                    ...
                    <table border="1" style=" border: solid #eee thin;" cellspacing="0" cellpadding="1"
                        ...
                        <thead style=" border: solid #eee thin;">
                            <tr style="height:40px; border: solid #eee thin;">
                                ...
                                <th style=" width:163px; border: solid #eee thin;text-align: left;">品牌</th>
                                <th style=" border: solid #eee thin;width:120px;text-align: left;">型号</th>
                                <th style=" border: solid #eee thin;width:128px;text-align: left;">描述</th>
                                <th style=" border: solid #eee thin;width:110px;text-align: left;">数量</th>
                                <th style=" border: solid #eee thin;width: 130px;text-align: left;">单价</th>
                                <th style=" border: solid #eee thin;width: 130px;text-align: left;">金额</th>
...
export default {
    ...
    methods: {
        ...
        handleChuangJiangone: function (row) {
            ...
            this.$router.push("/system/user-ckdbdfh/role/");
        },
