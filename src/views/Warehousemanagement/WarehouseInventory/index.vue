<template>
    <div class="app-container">
        <el-row :gutter="20" style="margin-left:-10%;">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                    ...
                    <el-form-item>
                        <el-button size="mini" type="danger" class="biaoto-buttonchaxuen" @click="handleQuery">查询
                        </el-button>
                ...
                <el-table border :header-cell-style="headClasswiry" v-loading="loading" :data="userList" height="580"
        ...
        <el-dialog :visible.sync="open2" class="chuangjiandialog">
            <span class="chuangjiancaigou">仓库盘点</span>
