        ...
        <el-row :gutter="20" style="margin-left:-10%;">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                    ...
                    <el-form-item >
                      <el-button v-hasPermi="['system:warehouseinventoryschedule:list']" size="mini"  class="biaoto-buttonchaxuen" @click="handleQuery">查询</el-button>
                      <el-button v-hasPermi="['system:warehouseinventoryschedule:list']" class="biaoto-buttonchuangjian" size="mini" @click="resetQuery">重置</el-button>
                        ...
                        <el-button size="mini" type="danger" class="biaoto-buttonshanchu" :disabled="multiple"
                                   v-hasPermi="['system:warehouseinventoryschedule:remove']"
                        ...
                        <el-button plain size="mini" class="biaoto-buttondaochu" :disabled="multiple"
                            @click="PurchaseinboundShenpi01" v-hasPermi="['system:warehouseinventoryschedule:pdwc']">盘点完成</el-button>
                        ...
                        <el-button plain size="mini" class="biaoto-buttonfanshen"
                            ...
                            v-hasPermi="['system:warehouseinventoryschedule:qxwc']">取消完成
                        </el-button>
                    </el-form-item>
                </el-form>
                ...
                <el-table border :header-cell-style="headClasswiry" :row-style="{height: '3px'}" :cell-style="{padding: '2px'}" v-loading="loading" :data="userList" height="470"
                    ...
                    <el-table-column label="盘点仓库" align="left" key="cbwa09" prop="cbwa09" sortable />
                    ...
                    <el-table-column label="操作" align="center" width="250" class-name="small-padding fixed-width">
                        <template slot-scope="scope" style="margin-left:-10%;">
                            ...
                            <el-button size="mini" type="text" icon="el-icon-share" class="caozuoxiangqeng"
                                @click="handleAuthRole(scope.row)" v-hasPermi="['system:warehouseinventoryschedule:detail']">详情
                            </el-button>
...
import { PurchasereturnordersAdd, SkuBarcodeLists, PurchaseinboundEdit, PurchasereturnorderRemove, Purchaseinboundsho, PurchaseinBoundshf, PurchaseinboundShtt, PurchaseinboundSht, SupplierList, GoodsList, StoreList, StoreSkuList } from "@/api/Warehousemanagement/WarehouseInventory";
import * as req from "@/api/Warehousemanagement/WarehouseInventory";
...
export default {
    ...
    methods: {
        ...
        handleSelectionChange(selection) {
            this.ids = selection;
            this.idss = selection.map(item => item.cbsh01);
        ...
        PurchaseinboundBiaojiWancheng(row) {
            this.$modal.confirm('是否要盘点ID为"' + row.cbsh01 + '"的数据项？').then(() => {
            console.log(row.cbpc01, 8888);
        ...
        PurchaseinboundBiaojiWancheng01(row) {
            this.$modal.confirm('是否要盘点ID为"' + this.idss + '"的数据项？').then(() => {
            let userIds = this.shenpiids.length > 0 ? this.shenpiids : row
            console.log(row.cbpc01, 8888);
        ...
        PurchaseinboundQuxiaoWangcheng(row) {
            console.log(row.cbpc01, 8888);
            this.$modal.confirm('是否要取消标记为"' + row.cbsh01 + '"的数据项？').then(() => {
        ...
        handlepdmxone: function (row) {
            ...
            this.$router.push("/system/user-pdmx/role/");
        },
        // /** 提交按钮 */
        // submitForm: function () {
