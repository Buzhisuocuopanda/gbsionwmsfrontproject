<template>
    <div>
        <el-form ref="form2" :model="form2" label-width="30%" :rules="rules" style="">
            <div class="chuangjiancaigous">库存汇总初始化</div>
            <el-row>
                <el-col :span="5">
                    ...
                    <table border="1" style=" border: solid #eee thin;" cellspacing="0" cellpadding="1"
                        ...
                        <thead style=" border: solid #eee thin;">
                            <tr style="height:40px; border: solid #eee thin;">
                                ...
                                <th style="width:162px; border: solid #eee thin;text-align: left;">品牌</th>
                                <th style=" width:163px; border: solid #eee thin;text-align: left;">类型</th>
                                ...
                                <th style=" border: solid #eee thin;width:110px;text-align: left;">价格</th>
                    ...
                    <div class="table-bodys" style="">
                        <table border="1" style=" border: solid #ffffff thin; width:1610px;height:42px;" cellspacing="0"
                            ...
                            <tr style="">
                                ...
                                <td style="width: 69px;border:solid #eee thin;">
...
<style src="./BarcodesSummarycjcss/index.css">
</style>