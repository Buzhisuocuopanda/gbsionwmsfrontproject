        ...
        <el-row :gutter="20" style="margin-left:-10%;">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-table border :header-cell-style="headClassSld" v-loading="loading" :data="userList" height="440"
                    ...
                    <el-table-column label="编号" align="left" key="orderNo" prop="orderNo" width="150px;" sortable fixed />
                    ...
                    <el-table-column label="收货人" align="left" key="contacts" width="120px;" prop="contacts" sortable />
                    <el-table-column label="收货电话" align="left" key="phone" width="120px;" prop="phone" sortable />
                    <el-table-column label="关联订单" align="left" key="cala08" width="120px;" prop="cala08" sortable />
                    ...
                    <el-table-column label="操作" align="center" width="250" fixed="right" class-name="small-padding fixed-width">
                        <template slot-scope="scope" style="margin-left:-10%;">
                            <el-button size="mini" type="text" icon="el-icon-edit"
                                ...
                                v-if="scope.row.status == 1 | scope.row.status == 2" v-hasPermi="['system:user:edit']">
                                修改
                            </el-button>
                ...
                <el-row>
                    <el-col style="margin-top:2%;margin-left: 2%;" :span="7">
                        <el-form-item label="客户:" prop="cala08">
                            ...
                            <el-select v-model="form2.supplierId" placeholder=""
                ...
                <el-row>
                    <el-col style="margin-top:-0.4%;margin-left: 2%;" :span="7">
                        <el-form-item label="联系人:" prop="cala08">
                            <el-input v-model="form2.cala08" maxlength="30" style="width:80%;border:solid #eee thin" />
                        </el-form-item>
                    </el-col>
                    <el-col style="margin-top:-0.4%;" :span="7">
                        <el-form-item label="电话:" prop="cala09">
                            <el-input v-model="form2.cala09" placeholder="" maxlength="30"
                                style="width:80%;border:solid #eee thin" />
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    ...
                    <el-col style="margin-top:-0.4%;margin-left: -3%;" :span="7">
                        <el-form-item label="关联订单:" prop="cala10">
                            <el-input v-model="form2.cala10" placeholder="" maxlength="30"
                                style="width:80%;border:solid #eee thin" />
                        </el-form-item>
                    </el-col>
                </el-row>
...
export default {
    ...
    methods: {
        ...
        PurchaseinboundQuxiaoWangcheng(row) {
            ...
            // console.log(row.cbpc01, 8888);
            this.$modal.confirm('是否要取消标记为ID"' + row.id + '"的数据项？').then(() => {
                Purchaseinbounds(row).then(response => {
                    console.log(this.form.id, 789);
                    this.getList();
...
<style src="./Salesladingcss/index.css">
</style>
