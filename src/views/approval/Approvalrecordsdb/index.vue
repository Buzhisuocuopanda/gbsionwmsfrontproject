    ...
    <div class="filter-container approlrdsdb">
      <el-form :inline="true" label-width="70px" style="flex-grow: 0;">
        ...
        <el-form-item style="margin: -5px -10px 1px 1px">
          <el-button v-hasPermi="['approval:approvalrecordsdb:list']" class="filter-item" type="primary"
        ...
        <el-table-column label="操作" min-width="100px;">
          <template slot-scope="scope">
            ...
            <el-button style="margin-left:8px; margin-top: 2px" icon="el-icon-share" size="mini" class="caozuoxiangqeng"
              type="text" v-hasPermi="['approval:approvalrecordsdb:detail']" @click="showDetail(scope.row)">详情
            </el-button>
            <el-button style="margin-top: 1px" icon="el-icon-edit" class="caozuoxiangqeng" size="mini" type="text"
