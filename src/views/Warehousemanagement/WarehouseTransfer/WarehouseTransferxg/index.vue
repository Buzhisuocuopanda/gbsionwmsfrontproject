        ...
        <el-form ref="form2" :model="form2" :rules="rules" label-width="35%" style="">
            ...
            <el-row>
                ...
                <el-col :span="7" v-if="false">
                    <el-form-item label="调出仓库id:" prop="cbaa09" style="margin-left:10%;">
                        <el-input type="text" v-model="form2.cbaa09" style="width: 50%;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col style="margin-left: 2%;" :span="5">
                    <el-form-item label="调出仓库:" prop="cbaa099">
                        <el-popover placement="bottom-start" trigger="click" clearable>
                            ...
                            <el-input slot="reference" v-model="form2.cbaa099" placeholder="" style="width:100%;">
                            </el-input>
                        </el-popover>
                    </el-form-item>
                </el-col>
                <el-col style="" :span="5">
                    <el-form-item label="调入仓库:" prop="cbaa100">
                        <el-popover placement="bottom-start" trigger="click" clearable>
                            ...
                            <el-input slot="reference" v-model="form2.cbaa100" placeholder="" style="width:100%;">
                            </el-input>
                        </el-popover>
                    </el-form-item>
                </el-col>
                ...
                <el-col style="margin-left: 2%;" :span="5">
                    <el-form-item label="结算货币:" prop="cbaa16">
                        ...
                        <el-select v-model="form2.cbaa16" placeholder="" style="width:100%;" @change="price">
                ...
                <!--订单类型展示-->
                <!-- <el-col style="margin-left: 2%;" :span="5">
                    <el-form-item label="关联订单:" prop="cbaa18">
                        <el-select v-model="form2.cbaa18" placeholder="" style="width:77%;">
            ...
            <el-row v-if="false">
                <el-col style="margin-top:-0.4%;margin-left: -3%;" :span="7">
                    <el-form-item label="调入仓库id:" prop="cbaa10">
                        <el-input v-model="form2.cbaa10" placeholder="" maxlength="30" style="width:80%;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <div>
                ...
                <el-table :data="tableData" border :span-method="arraySpanMethod" :row-style="{ height: '10px' }"
                    ...
                    <el-table-column v-if="false" prop="cbab08" label="商品id" width="150">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.cbab08" placeholder="商品id" style=""></el-input>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="cbpc099" label="供应商" width="180">
                        <template slot-scope="scope">
                            <el-popover placement="bottom-start" trigger="click">
                                ...
                                <el-input slot="reference" v-model="scope.row.cbab144" placeholder="" readonly
                                    style="width:100%;">
                                </el-input>
                            </el-popover>
                        </template>
                    </el-table-column>
                    <el-table-column v-if="false" prop="cbab14" label="供应商id" width="150">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="cbab13" label="备注" width="">
                        <template slot-scope="scope">
                            <el-input v-model="scope.row.cbab13" placeholder=""></el-input>
                        </template>
                    </el-table-column>

                    <el-table-column v-if="false" prop="cbaa01" label="主明细id" width="150">
                        <template slot-scope="scope">
                            <sapn>
                                <el-input v-model="scope.row.cbaa01" placeholder="id" style=""></el-input>
                            </sapn>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        selected011(name) {
            console.log(name, 123)
            console.log(name.substring(name.indexOf("-") + 1), 963);
            this.form2.cbaa099 = name.substring(0, name.indexOf("-"))
            this.form2.cbaa09 = name.substring(name.indexOf("-") + 1)
            // this.form2.icon = name;
        },
        ...
        selected02(e, row) {
            ...
            // this.form2.icon = name;
            this.$set(row, "cbab144", e.substring(0, e.indexOf("-")))
            console.log(e, 111)
            console.log(row, 222)
            // row.cbpc08 = e.substring(e.indexOf(".") + 1)
            this.$set(row, "cbab14", e.substring(e.indexOf("-") + 1), 8523642)
        },
        ...
        handleAdd() {
            ...
            this.$refs["form2"].validate((item) => {
                if (item) {
                    Selloutofwarehouseaupdate(this.form2).then(response => {
                        if (response.code == "200") {
        ...
        getList() {
            ...
            PurchaseinboundLists(id, this.addDateRange(this.queryParams, this.dateRange)).then(response => {
                ...
                // // 编号
                // this.form2.cbsb07 = res.cbaa07;
                // // 调入仓库名称
                // this.form2.cbpc100 = res.cbwa09;
                // // 调入仓库名称ID
                // this.form2.cbsb10 = res.whId;
                // // 调出仓库名称
                // this.form2.cbpc1000 = res.cbwa10;
                // // 调出仓库名称ID
                // this.form2.cbaa09 = res.whId;
                // //结算货币名称
                // this.form2.cbaa16 = res.cala08;
                // //结算货币名称id 
                ...
                console.log(this.form2, 170991611111111111);
            }
            );
        },
...
<style src="./WarehouseTransferxgcss/index.css">
