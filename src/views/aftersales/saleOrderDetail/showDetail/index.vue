  ...
  <div class="app-container">
    ...
    <el-form ref="form2" :model="form2" label-width="130px" :rules="rules" style="" class="demo-ruleForm">
      ...
      <el-descriptions :column="3" border style="margin-top: 30px">
        ...
        <el-descriptions-item label="客户单号" labelStyle="width: 20%;text-align:center">{{this.formData.customerNo}}
        </el-descriptions-item>
        ...
        <el-descriptions-item label="结算货币" labelStyle="width: 20%;text-align:center">{{this.formData.currencyMsg}}
        </el-descriptions-item>
        <el-descriptions-item label="收货人" labelStyle="width: 20%;text-align:center">{{this.formData.receiveName}}
        </el-descriptions-item>
        <el-descriptions-item label="电话" labelStyle="width: 20%;text-align:center">{{this.formData.receivePhone}}
        </el-descriptions-item>
        <el-descriptions-item label="发票类型" labelStyle="width: 20%;text-align:center">{{this.formData.invoiceType}}
        </el-descriptions-item>
        <el-descriptions-item label="订单类型" labelStyle="width: 20%;text-align:center">{{this.formData.orderTypeMsg}}
        </el-descriptions-item>
        <el-descriptions-item label="工厂账号" labelStyle="width: 20%;text-align:center">{{this.formData.fcNumber}}
        </el-descriptions-item>
        <el-descriptions-item label="订单分类" labelStyle="width: 20%;text-align:center">{{this.formData.orderClassMsg}}
        </el-descriptions-item>
        <el-descriptions-item label="地址" labelStyle="width: 20%;text-align:center">{{this.formData.address}}
        </el-descriptions-item>
        <el-descriptions-item label="备注" labelStyle="width: 20%;text-align:center">{{this.formData.remark}}
        </el-descriptions-item>
        <el-descriptions-item label="纳税人识别号" labelStyle="width: 20%;text-align:center">{{this.formData.taxpayerid}}
        </el-descriptions-item>
        <el-descriptions-item label="发票地址" labelStyle="width: 20%;text-align:center">{{this.formData.fpAdress}}
        </el-descriptions-item>
        <el-descriptions-item label="发票电话" labelStyle="width: 20%;text-align:center">{{this.formData.fpPhone}}
        </el-descriptions-item>
        <el-descriptions-item label="发票开户行" labelStyle="width: 20%;text-align:center">{{this.formData.fpbank}}
        </el-descriptions-item>
        <el-descriptions-item label="发票账号" labelStyle="width: 20%;text-align:center">{{this.formData.fpNumber}}
        </el-descriptions-item>
        <el-descriptions-item label="发票邮寄地址" labelStyle="width: 20%;text-align:center">
          {{this.formData.fpReceiveAddress}}</el-descriptions-item>
        <el-descriptions-item label="其他" labelStyle="width: 20%;text-align:center">{{this.formData.other}}
        </el-descriptions-item>
      </el-descriptions>
      <!-- 编号:56221589223 -->
    ...
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="本页金额小计" labelStyle="width: 30%;text-align:center">{{this.formData.sumPrice}}
      </el-descriptions-item>
      <el-descriptions-item label="合计数量" labelStyle="width: 30%;text-align:center">{{this.formData.sumQty}}
      </el-descriptions-item>
      <el-descriptions-item label="合计金额" labelStyle="width: 30%;text-align:center">{{this.formData.sumPrice}}
      </el-descriptions-item>
