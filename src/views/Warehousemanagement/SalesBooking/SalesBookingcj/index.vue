  ...
  <div class="app-container">
    <el-form ref="form2" :model="form2" label-width="130px" :rules="rules" style="">
      ...
      <div>
        ...
        <el-table :data="goods.goods" border :span-method="arraySpanMethod" :row-style="{height: '10px'}" :cell-style="{padding: '5px'}" style="width: 100%;margin-top: 10px;">
  ...
  export default {
    ...
    methods: {
      ...
      _ly_ok() {
        ...
        //   }
          ...
          // this.$refs[form.formName][0].validate((valid, obj) => {
            // if (valid) {
              ...
              console.log(this.goods,333)
              PurchaseinboundAdd(JSON.stringify(this.goods)).then(response => {
        ...
        console.log('_ly_ok:' + JSON.stringify(this.goods))
      },
      ...
      _ly_addFrom() {
        ...
        this.dataId++
        console.log(this.goods,852369);
      },
      // 删除一行表单
      _ly_delFrom(row) {
        // console.log('index: ' + index)
        // this.formArr.splice(index, 1)
        this.goods.splice(this.goods.indexOf(row), 1)
      },
      // 点击select的时候，缓存下行号
      ...
      _ly_chooseNode(data) {
        ...
        // 选择后收起下拉框
        let formName = this.goods[index].formName
