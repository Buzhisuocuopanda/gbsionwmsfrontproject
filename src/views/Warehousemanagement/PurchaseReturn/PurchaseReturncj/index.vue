      ...
      <el-row v-if="false">
        ...
        <el-col style="margin-top:-0.4%;margin-left: -3%;" :span="7">
          <el-form-item label="仓库id:" prop="cbpg10">
            <el-input v-model="form2.cbpg10" placeholder="" maxlength="30" style="width:80%;border:solid #eee thin" />
          </el-form-item>
        </el-col>
        <!-- 商品信息维护 -->
        <el-col>
          <el-form-item label="" v-if="false" prop="cbph08" style="margin-left:0.8%;">
            <el-input v-model="form2.cbph08" style="border:solid #eee thin;width:70%;"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <div>
        ...
        <el-table :data="tableData" border :span-method="arraySpanMethod" style="width: 100%;margin-top: 10px;">
         <!-- <el-form ref="form" :model="form" label-width="55%" lable-height="20%" class="chuangjianform"> -->
          ...
          <el-table-column prop="cbph09" label="数量" width="150">
            <template slot-scope="scope">
              <!-- <sapn> -->
                <el-input v-model="scope.row.cbph09" @blur="chen(scope.row)" placeholder="数量" style=""></el-input>
              <!-- </sapn> -->
            </template>
          </el-table-column>
          <el-table-column prop="cbph10" label="单价"  width="150">
            <template slot-scope="scope">
              <!-- <sapn> -->
                <el-input v-model="scope.row.cbph10" @blur="chen(scope.row)" placeholder="单价" style=""></el-input>
              <!-- </sapn> -->
            </template>
          </el-table-column>
          <el-table-column prop="cbph11" label="金额" width="150">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.cbph11" placeholder="金额" style=""></el-input>
              </sapn>
            </template>
          </el-table-column>
          <el-table-column prop="cbph13" label="备注" width="">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.cbph13" type="textarea" placeholder="备注"></el-input>
              </sapn>
            </template>
          </el-table-column>

          <el-table-column v-if="false" prop="cbpg01" label="id" width="150">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.cbpg01" placeholder="id" style=""></el-input>
              </sapn>
            </template>
          </el-table-column>
          <el-table-column v-if="false" prop="cbph08" label="商品编号" width="150">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.cbph08" placeholder="商品编号" style=""></el-input>
              </sapn>
            </template>
          </el-table-column>
