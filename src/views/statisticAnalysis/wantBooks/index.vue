  ...
  <div class="app-container prodtotal">
    ...
    <el-form ref="form" :model="queryParams" label-width="80px" inline>
      <el-form-item label="商品分类">
        <el-select v-model="queryParams.cbpa07" style="width: 200px" clearable filterable placeholder="请输入关键词"
          :loading="loading3">
          <el-option v-for="item in cbpaList" :key="item.cbpa07" :label="item.cbpa07 + ' [' + item.cbpa11 + ']'"
            :value="item.cbpa07"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="品牌">
        <el-select v-model="queryParams.cala08" style="width: 200px" clearable filterable placeholder="请输入关键词"
          :loading="loading2">
          <el-option v-for="item in calaList" :key="item.cala08" :label="item.cala08 + ' [' + item.cala09 + ']'"
            :value="item.cala08"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item>
        <el-button v-hasPermi="['countQuery:invsentorsysummaryquery:list']" class="filter-item" type="primary"
          @click="handleQuery">查询</el-button>
        <el-button v-hasPermi="['countQuery:invsentorsysummaryquery:list']" class="filter-item" type="primary"
          style="margin-bottom:0;margin-left: 1em" @click="resetQuery">重置</el-button>
        <el-button v-hasPermi="['countQuery:invsentorsysummaryquery:export']" class="filter-item" type="primary"
    ...
    <el-table :data="tableData" :header-cell-style="headClasspw" style="width: 100%;margin-top:0.1em"
      ...
      <el-table-column prop="cboe08" width="110" :formatter="formatTime" label="日期" align="left" sortable>
      </el-table-column>
    </el-table>
