    ...
    <div class="app-container">
        <el-form ref="form2" :model="form2" label-width="130px" style="">
            ...
            <el-row :gutter="20">
                ...
                <el-col style="" :span="6">
                    <el-form-item label="客户名称:" prop="cbpc0999" class="CustomerMainten">
                        <!-- <el-popover placement="bottom-start" trigger="click" class="CustomerMainten">
                            <CustomerMainten ref="CustomerMainten" @selected="selected022"
                                style="width:210px!important; height:100px!important;" />
                            <el-input :disabled="true" slot="reference" v-model="form2.cbpc0999" placeholder="" readonly
                                style="width:110%;">
                            </el-input>
                        </el-popover> -->
                        <el-input type="text" :disabled="true" v-model="form2.cbpc0999" style="width: 100%;" />

                    </el-form-item>
                </el-col>
                <el-col style="margin-left:-2%;" :span="6">
                    <el-form-item label="供料单位:" prop="cbpc099" class="supplierMaintenance">
                        <!-- <el-popover placement="bottom-start" trigger="click">
                            <supplierMaintenance ref="supplierMaintenance" @selected="selected02"
                                style="width:210px!important;" />
                            <el-input :disabled="true" slot="reference" v-model="form2.cbpc099" placeholder="" readonly
                                style="width:100%;">
                            </el-input>
                        </el-popover> -->
              ...
              <el-option v-for="item in jiageLeixeng" :key="item.value" :label="item.label" :value="item.value">
                    ...
                    <el-form-item label="销售人员:" prop="salerId" class="salerman">
                        <!-- <el-popover placement="bottom-start" trigger="click" clearable>
                            ...
                            <el-input :disabled="true" slot="reference" v-model="form2.cbsb177" placeholder="" readonly
                                style="width:85%;">
                            </el-input>
                        </el-popover> -->
            ...
            <el-row v-if="false">
                ...
                <el-col style="margin-top:0%;margin-left: -3%;" :span="7">
                    <el-form-item label="仓库id:" prop="whId">
                        <el-input :disabled="true" v-model="form2.whId" placeholder="" maxlength="30"
                            style="width:80%;border:solid #eee thin" />
                    </el-form-item>
                </el-col>
                <el-col style="margin-top:0%;margin-left: -3%;" :span="7">
                    <el-form-item label="客户id:" prop="customerId">
                        <el-input :disabled="true" v-model="form2.customerId" placeholder="" maxlength="30"
                            style="width:80%;border:solid #eee thin" />
                    </el-form-item>
                </el-col>
                <el-col style="margin-top:0%;margin-left: -3%;" :span="7">
                    <el-form-item label="销售人员id:" prop="salerId">
                        <el-input :disabled="true" v-model="form2.salerId" placeholder="" maxlength="30"
                            style="width:80%;border:solid #eee thin" />
                    </el-form-item>
                </el-col>
                <el-col style="margin-top:0%;margin-left: -3%;" :span="7">
                    <el-form-item label="销售预订单id:" prop="gsSalesOrders">
                        <el-input :disabled="true" v-model="form2.gsSalesOrders" placeholder="" maxlength="30"
                            style="width:80%;border:solid #eee thin" />
                    </el-form-item>
                </el-col>
                <!-- 商品信息维护 -->
            ...
            <div>
                ...
                <el-table :data="tableData" border :span-method="arraySpanMethod" :row-style="{height: '10px'}"
                    ...
                    <el-table-column prop="cbpc000" label="品牌" width="300">
                        <template slot-scope="scope" style="width:200%;">
                            <!-- <el-popover placement="bottom-start" trigger="click">
                                ...
                                <el-input :disabled="true" slot="reference" v-model="scope.row.cbpc000" placeholder="" readonly
                                    style="width:100%;">
                                </el-input>
                            </el-popover> -->
                    ...
                    <el-table-column prop="orderDate" label="订单日期" width="215">
                        <template slot-scope="scope">
                            <el-date-picker :disabled="true" type="date" placeholder="" v-model="scope.row.orderDate"
                                style="width:100%;" class="orderDatescope">
                            </el-date-picker>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column v-if="false" prop="salerId" label="销售人员id" width="150">
                        <template slot-scope="scope">
                            <el-input :disabled="true" v-model="scope.row.salerId" placeholder="" style=""></el-input>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        handleUpdate() {
            ...
            PurchaseinboundEditSalesAdvance(JSON.stringify(row)).then(response => {
                if (response.code == "200") {
