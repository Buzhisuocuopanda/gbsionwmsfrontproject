            ...
            <el-row>
                <el-col style="margin-left: 2%;" :span="5">
                    <el-form-item label="客户:" prop="cbse09">
                        <el-input type="text" v-model="form2.cbse09" style="border:solid #eee thin; width:100%;" />
                    </el-form-item>
                </el-col>
                <el-col style="" :span="5">
                    <el-form-item label="仓库:" prop="cbpc100">
                        <el-popover placement="bottom-start" trigger="click" clearable>
                            ...
                            <el-input slot="reference" v-model="form2.cbpc100" placeholder="" readonly
                                style="border:solid #eee thin; width:100%;">
                            </el-input>
                        </el-popover>
                    </el-form-item>
                </el-col>
                ...
                <el-col v-if="false"  style="margin-left: 2%;" :span="5">
                    <el-form-item label="结算货币:" prop="cbse16">
                        <el-input type="text" v-model="form2.cbse16" style="border:solid #eee thin; width:100%;" />
                    </el-form-item>
                </el-col>
                <!--结算货币展示-->
                <el-col  style="margin-left: 2%;" :span="5">
                    <el-form-item label="结算货币:" prop="cbse166">
                        <el-input type="text" v-model="form2.cbse166" style="border:solid #eee thin; width:100%;" />
                    </el-form-item>
                </el-col>
                <!--订单类型展示-->
                 <el-col  style="margin-left: 2%;" :span="5">
                    <el-form-item label="关联订单:" prop="cbse18">
                        <el-input type="text" v-model="form2.cbse188" style="border:solid #eee thin; width:100%;" />
                    </el-form-item>
                </el-col>
                <!--订单类型id-->
                <el-col  v-if="false" style="margin-left: 2%;" :span="5">
                    <el-form-item label="关联订单:" prop="cbse18">
                        <el-input type="text" v-model="form2.cbse18" style="border:solid #eee thin; width:100%;" />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                  <el-col style="margin-top: -1%;" :span="7" v-if="false">
                    <el-form-item label="主明细键:" prop="cbsb21">
                        <el-input type="text" v-model="form2.cbsb211" style="border:solid #eee thin; width:77%;" />
                    </el-form-item>
                </el-col>
                  <el-col style="margin-top: -1%;" :span="7" v-if="false">
                    <el-form-item label="审核时间:" prop="cbse13">
                        <el-input type="text" v-model="form2.cbse13" style="border:solid #eee thin; width:77%;" />
                    </el-form-item>
                </el-col>
                 <el-col style="margin-top: -1%;" :span="7" v-if="false">
                    <el-form-item label="完成时间:" prop="cbse15">
                        <el-input type="text" v-model="form2.cbse15" style="border:solid #eee thin; width:77%;" />
                    </el-form-item>
                </el-col>
                <el-col style="margin-top: -1%;" :span="7" v-if="false">
                    <el-form-item label="审核状态:" prop="cbse11">
                        <el-input type="text" v-model="form2.cbse11" style="border:solid #eee thin; width:77%;" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="false">
                <el-col style="margin-top:-0.4%;margin-left: -3%;" :span="7">
                    <el-form-item label="仓库id:" prop="cbsb10">
                        <el-input v-model="form2.cbsb10" placeholder="" maxlength="30"
            ...
            <div  width="1050px" center  :before-close="_ly_beforeClose" @close="_ly_closeDialog">
              <span slot="footer" class="dialog-footer" style="margin-left:2%; padding-top:-2%;">
               ...
               <table style="margin-top:2%;">
                ...
                <el-row  style="width:110%;" :key="index">
                    <el-form label-position="right" label-width="50px" style="margin-top:2%;"
                        :inline="true">  
                        <!--供应商id-->
                        <el-form-item label="" size="small" prop="cbsf15" style="margin-left:0.8%;" v-if="false">
                            <el-input v-model="form.cbsf15" style="border:solid #eee thin;width:50%;"></el-input>
                        </el-form-item>
                        <!--供应商展示-->
                        <el-form-item label="" size="small" prop="cbsf155" style="margin-left:0.8%;">
                            <el-input v-model="form.cbsf155" style="border:solid #eee thin;width:50%;"></el-input>
                        </el-form-item>
                        <!--订单分类id-->
                        <el-form-item label="" size="small" prop="cbsf16" style="margin-left:-7%;" v-if="false">
                            <el-input  v-model="form.cbsf16" style="border:solid #eee thin;width:50%;"></el-input>
                        </el-form-item>
                        <!--订单分类展示-->
                        <el-form-item label="" size="small" prop="cbsf166" style="margin-left:-7%;">
                            <el-input  v-model="form.cbsf166" style="border:solid #eee thin;width:50%;"></el-input>
                        </el-form-item>

                        <el-form-item label="" size="small" prop="cbsf08" style="margin-left:-7%;">
                            <el-input v-model="form.cbsf08" style="border:solid #eee thin;width:55%;"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="" size="small" prop="cbsf09" style="margin-left:-6%;">
                            <el-input v-model="form.cbsf09" style="border:solid #eee thin; width:50%;"></el-input>
                        </el-form-item>
                        <el-form-item label="" size="small" prop="cbsf11" style="margin-left:-6%;">
                            <el-input v-model="form.cbsf11" style="border:solid #eee thin;width:55%;"></el-input>
                        </el-form-item>
                        <el-form-item label="" size="small" prop="cbsf12" style="margin-left:-6%;">
                            <el-input v-model="form.cbsf12" style="border:solid #eee thin;width:55%;"></el-input>
                        </el-form-item>
                        <el-form-item label="" size="small" prop="cbsf13" style="margin-left:-4%;">
                            <el-input v-model="form.cbsf13" style="border:solid #eee thin;width:60%;"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item v-if="false" label="" size="small" prop="cbsc08" style="margin-left:-4%;">
                            <el-input v-model="form.cbsc08" style="border:solid #eee thin;width:60%;"></el-input>
                        </el-form-item>
                        <el-form-item v-if="false" label="" size="small" prop="cbsc10" style="margin-left:-4%;">
                            <el-input v-model="form.cbsc10" style="border:solid #eee thin;width:60%;"></el-input>
                        </el-form-item>
...
import { PurchaseinboundAdds,PurchaseinboundAdd } from "@/api/Warehousemanagement/SalesShipment";
            ...
            this.$refs["form2"].validate((item) => {
                if (item) {
                    PurchaseinboundAdd(this.form2).then(response => {
                        ...
                        this.open2 = false;
                        this.reset01();
                        this.form2.cbsb211 = response.data.id;
...
<style src="./SalesStockcjcss/index.css">
</style>