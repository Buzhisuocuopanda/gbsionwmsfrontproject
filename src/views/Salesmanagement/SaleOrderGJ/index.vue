    ...
    <div class="filter-container saleorderGj">
      <el-form :inline="true" label-width="70px">
        ...
        <el-form-item style="margin: -5px -10px 1px 1px">
          ...
          <!--          </el-upload>-->
          <el-button v-hasPermi="['sale:saleOrder:import']" type="primary" v-on:click="handleImport()"
            style="margin-bottom:0;margin-left: 1em">导入</el-button>
        ...
        <el-table-column fixed="right" label="操作" min-width="180px;">
          <template slot-scope="scope">
            <el-button class="caozuoxiangqengGJ" style="margin-left:8px; margin-top: 2px" size="mini"
              ...
              详情</el-button>
            <el-button style="margin-top: 2px" v-show="scope.row.status==0" size="mini" type="primary"
