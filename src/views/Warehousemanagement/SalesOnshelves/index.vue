<template>
    ...
    <div class="app-container">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                    ...
                    <el-form-item prop="customerName" label="sn">
                        <el-input v-model="queryParams.sn" id="miaoshu" placeholder="" clearable style="width: 240px;"
                    ...
                    <el-form-item>
                        <el-button v-hasPermi="['system:sellinglistings:list']" size="mini" class="biaoto-buttonchaxuen"
                ...
                <el-table border :header-cell-style="headClasspw" :row-style="{height: '3px'}"
                    ...
                    <el-table-column label="库位码" align="left" key="locationName" prop="locationName" sortable
                        width="150px;">
                    </el-table-column>
        ...
        <!--修改-->
        <el-dialog :title="title" :visible.sync="open" class="abow_dialoggn">
            <div
                    ...
                    <el-row style="margin-left:5%;margin-top:2%;">
                        <el-col :span="11">
                            <el-form-item label="客户编号:" prop="customerNo">
                                <el-input v-model="form.customerNo" maxlength="30" placeholder="" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="11">
                            <el-form-item label="客户名称:" prop="customerName">
                                <el-input v-model="form.customerName" maxlength="30" placeholder=""
                                    style="width:100%;" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row style="margin-left:5%;margin-top:2%;">
                        <el-col :span="11">
                            <el-form-item label="客户等级:" prop="customerLevel">
                                <el-input v-model="form.customerLevel" placeholder="" maxlength="30"
                                    style="width:100%;" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="11">
                            <el-form-item label="联系人:" prop="contacts">
                                <el-input v-model="form.contacts" placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row style="margin-left:5%;margin-top:3%;">
                        <el-col :span="11">
                            <el-form-item label="联系电话:" prop="phone ">
                                <el-input v-model="form.phone " placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="11">
                            <el-form-item label="销售用户:" prop="saleUser">
                                <el-input v-model="form.saleUser" placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row style="margin-left:5%;margin-top:2%;">
                        <el-col :span="11">
                            <el-form-item label="仓库名称:" prop="whName">
                                <el-input v-model="form.whName" placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="11">
                            <el-form-item label="地址:" prop="address">
                                <el-input v-model="form.address" placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row style="margin-left:5%;margin-top:2%;">
...
import { PurchaseinboundAdd, PurchaseinboundList, PurchaseinboundEdit, PurchaseinboundRemove, PurchaseinboundSH, PurchaseinboundShs, Purchaseinbounds, PurchaseinboundShss, SupplierList, GoodsList01, StoreList, StoreSkuList, PurchaseinboundLists } from "@/api/Warehousemanagement/SalesOnshelves";
import * as req from "@/api/Warehousemanagement/SalesOnshelves";
...
export default {
    ...
    methods: {
        ...
        handleSelectionChange(selection) {
            this.ids = selection;
            this.idss = selection.map(item => item.customerName);
        ...
        handleUpdate() {
            if (this.form.name != undefined) {
                ...
                row.customerLevel = this.form.customerLevel;
                row.contacts = this.form.contacts;
                row.phone = this.form.phone;
                row.saleUser = this.form.saleUser;
                row.whName = this.form.whName;
        ...
        handlexiangqengSelect(row) {
            ...
            this.form.saleUser = row.saleUser;
            this.form.whName = row.whName;
        ...
        handleChuangJiangone: function (row) {
            // this.$router.push("/system/user-auth/role/");
            this.$router.push("/system/user-xssjdan/role/");
        },
        ...
        handleDelete(row) {
            ...
            this.$modal.confirm('是否确认删除客户名称为"' + JSON.stringify(this.idss) + '"的数据项？').then(() => {
                userIds.forEach((item) => {
        ...
        handleDelete01(row) {
            ...
            this.$modal.confirm('是否确认删除客户名称为"' + row.customerName + '"的数据项？').then(function () {
                return PurchaseinboundRemove(row);
            }).then((response) => {
                this.submitShangpin();
                this.getList();
                this.$modal.msgSuccess("删除成功");
