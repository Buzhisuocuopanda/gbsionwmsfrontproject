    ...
    <div class="filter-container prodtotal">
      <el-form :inline="true">
        ...
        <el-form-item label="仓库" style="margin-left: 20px" class="item-r">
          <el-select style="margin-left: 10px" v-model="queryParams.cbib02" clearable filterable remote reserve-keyword
        ...
        <el-form-item style="margin: 0px -10px 1px 1px;">
          <el-button v-hasPermi="['query:monthlyStockInAndOut:list']" class="filter-item" type="primary"
          ...
          <el-button v-hasPermi="['query:monthlyStockInAndOut:export']" class="filter-item" type="primary"
