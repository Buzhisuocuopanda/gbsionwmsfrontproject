            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-table border :header-cell-style="headClasspw" v-loading="loading" :data="userList" height="430"
                    ...
                    <el-table-column label="仓库名称" align="left" key="whName" prop="whName" sortable width="180px;">
                      ...
                      <el-table-column label="地址" align="left" key="address" prop="address" sortable width="180px;">
                    </el-table-column>
                    ...
                    <el-row style="margin-left:5%;margin-top:2%;">
                        ...
                        <el-col :span="11">
                            <el-form-item label="客户名称:" prop="customerName">
                                <el-input v-model="form.customerName" maxlength="30" placeholder="" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row style="margin-left:5%;margin-top:2%;">
                        <el-col :span="11">
                            <el-form-item label="客户等级:" prop="customerLevel">
                                <el-input v-model="form.customerLevel" placeholder="" maxlength="30" style="width:100%;" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="11">
