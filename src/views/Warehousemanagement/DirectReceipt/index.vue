    ...
    <div class="app-container">
        <el-row :gutter="20" style="margin-left:-10%;">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-table border :header-cell-style="headClassDR" :row-style="{height: '3px'}" :cell-style="{padding: '2px'}" v-loading="loading" :data="userList" height="470"
                        ...
                        <template slot-scope="scope" style="margin-left:-10%;">
                            ...
                            <!-- <el-button size="mini" type="text" icon="el-icon-share" class="caozuoxiangqeng"
                                ...
                                <el-button size="mini" type="text" icon="el-icon-s-order" class="caozuoxiangqeng"
                                    ...
                                    v-hasPermi="['system:user:remove']" v-if="scope.row.cbpg11 == 4">取消完成</el-button>
                                <el-button size="mini" type="text" icon="el-icon-s-order" class="caozuoxiangqeng"
...
// import { PurchasereturnordersAdd, SkuBarcodeLists, PurchaseinboundEdit, PurchasereturnorderRemove, Purchaseinboundsho, PurchaseinBoundshf, PurchaseinboundShtt, PurchaseinboundSht, SupplierList, GoodsList, StoreList, StoreSkuList } from "@/api/Warehousemanagement/DirectReceipt";
import { PurchaseinboundAdd, SkuBarcodeLists, PurchaseinboundEdit, PurchaseInboundremove, Purchaseinboundsho, PurchaseinBoundshf, PurchaseinboundShtt, PurchaseinboundSht, SupplierList, GoodsList, StoreList, StoreSkuList } from "@/api/Warehousemanagement/DirectReceipt";
import * as req from "@/api/Warehousemanagement/DirectReceipt";
...
export default {
    ...
    methods: {
        ...
        handleSelectionChange(selection) {
            this.ids = selection;
            this.idss = selection.map(item => item.cbic01);
