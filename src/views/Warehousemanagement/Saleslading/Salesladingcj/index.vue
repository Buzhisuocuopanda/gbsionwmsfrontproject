      ...
      <el-row>
        <el-col style="margin-left: 2%; margin-top: -1%" :span="7">
          <el-form-item label="结算货币:" prop="cbsb166">
            ...
            <el-select
              v-model="form2.cbsb166"
              placeholder=""
              style="width: 77%"
              disabled
            >
              <el-option
                v-for="item in jiageLeixenghuobi"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              >
...
<style src="./Salesladingcjcss/index.css"></style>
