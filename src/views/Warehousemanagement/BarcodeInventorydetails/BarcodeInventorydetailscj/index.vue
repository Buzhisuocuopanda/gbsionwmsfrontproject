                    ...
                    <table border="1" style=" border: solid #eee thin;" cellspacing="0" cellpadding="1"
                        ...
                        <thead style=" border: solid #eee thin;">
                            <tr style="height:40px; border: solid #eee thin;">
                                ...
                                <th style="width:162px; border: solid #eee thin;text-align: left;">库位</th>
                                <th style=" width:163px; border: solid #eee thin;text-align: left;">品牌</th>
                                <th style=" border: solid #eee thin;width:120px;text-align: left;">类型</th>
                                <th style=" border: solid #eee thin;width:128px;text-align: left;">型号</th>
                                <th style=" border: solid #eee thin;width:110px;text-align: left;">描述</th>
                                <th style=" border: solid #eee thin;width: 130px;text-align: left;">商品SN</th>
                                <th style=" border: solid #eee thin;width: 130px;text-align: left;">价格</th>
                                <th style=" border: solid #eee thin;width: 130px;text-align: left;">入库时间</th>
                    ...
                    <div class="table-bodys" style="">
                        <table border="1" style=" border: solid #ffffff thin; width:1610px;height:42px;" cellspacing="0"
                            ...
                            <tr style="">
                                ...
                                <td style="width: 181px;border:solid #eee thin;">
                                    <el-input type="text" v-model="form2.cbpc12" style="" />
                                </td>
                                <td style="width: 183px;border:solid #eee thin;">
                                    <el-input type="text" v-model="form2.cbpd08" id="input1" style="" />
                                </td>
                                <td style="width: 134px;border:solid #eee thin;">
                                ...
                                <td style="width: 121px;border:solid #eee thin;">
