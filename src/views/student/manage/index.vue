  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open1" width="500px" append-to-body>
      <el-form ref="form1" :model="form1" :rules="rules" label-width="80px">
        <el-form-item label="学生名称" prop="studentName">
          <el-input v-model="form1.studentName" readonly="true" />
        </el-form-item>
        <el-form-item label="年龄" prop="studentAge">
          <el-input v-model="form1.studentAge" readonly="true"  />
        </el-form-item>
        <el-form-item label="爱好" prop="studentHobby">
          <el-input v-model="form1.studentHobby" readonly="true"  />
        </el-form-item>
        <el-form-item label="生日" prop="studentBirthday">
          <el-date-picker clearable readonly="true"
                          v-model="form1.studentBirthday"
                          type="date"
                          value-format="yyyy-MM-dd"
          >
          </el-date-picker>
