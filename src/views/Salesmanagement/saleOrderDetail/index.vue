      ...
      <el-row :gutter="20" style="margin-top: 1px;">
        <el-col :span="8">
          <el-form-item label="客户:" prop="customer">
            <el-select @change="customerOnChange" v-loadmore="customerloadMore" v-model="formData.customer" filterable clearable :filter-method="customerdataFilter" placeholder="请选择" style="width: 70%;">
              <el-option
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="订单类型:" prop="orderType">
            <el-input type="text" v-model="formData.orderType" style="width: 70%;" disabled/>
          </el-form-item>
        ...
        <el-col :span="8">
          <el-form-item label="订单分类:" prop="orderClass">
            <el-input type="text" v-model="formData.orderClass" style="width: 70%;"  disabled/>
          </el-form-item>
...
<!--      </el-row>-->
      <div>
        ...
        <el-table :data="tableData" border :span-method="arraySpanMethod" style="width: 100%;margin-top: 10px;">
          <el-table-column prop="id" label="品牌" width="">
            <template slot-scope="scope">
              <sapn>
                <el-select @change="goodsOnChange(scope.row)" v-loadmore="loadMore" v-model="scope.row.id" filterable clearable :filter-method="dataFilter" placeholder="请选择" style="width: 100%;">
                  <el-option
          ...
          <el-table-column prop="qty" label="数量" width="150">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.qty" placeholder="数量" style=""></el-input>
              </sapn>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="currentPrice" label="本次单价" width="150">
            <template slot-scope="scope">
              <sapn>
                <el-input v-model="scope.row.currentPrice" placeholder="本次单价" style=""></el-input>
              </sapn>
            </template>
          </el-table-column>
...
//        this.options=this.options2
      ...
      goodsOnChange(row){
        ...
        if(this.formData.customer==null){
            this.$message.error("请先选择客户")
          return;
          }
        const param={
          goodsId: row.id,
          customerId: this.formData.customer
