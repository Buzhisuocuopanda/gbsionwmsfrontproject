    ...
    <div class="filter-container">
      <el-form :inline="true" label-width="70px">
        ...
        <el-form-item style="margin: -5px -10px 1px 1px">
          ...
          <el-button v-hasPermi="['system:saleChange:add']" class="filter-item" type="primary"
          ...
          <!--          </el-upload>-->
          <el-button v-hasPermi="['system:saleChange:export']" class="filter-item" type="primary"
      ...
      <el-table :data="orderList" :row-style="{height: '3px'}" :cell-style="{padding: '2px'}"
        ...
        <el-table-column fixed="right" label="操作" min-width="250px;">
          <template slot-scope="scope">
            <el-button v-hasPermi="['system:saleChange:detail']" class="caozuoxiangqengChange"
