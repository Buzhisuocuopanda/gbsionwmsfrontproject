  ...
  <div class="app-container">
    ...
    >
      ...
      <el-row :gutter="20" style="margin-top: 20px">
        <el-col :span="8">
          <el-form-item label="编号:" prop="cbpc07">
            <el-input type="text" v-model="form2.cbpc07" style="width: 60%;" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row :gutter="20">
        <el-col
          v-if="false"
          style="margin-top: -0.4%; margin-left: -3%"
          :span="7"
        >
          <el-form-item label="主副表id:" prop="cbpg161">
            <el-input
              v-model="form2.cbpg161"
              placeholder=""
              maxlength="30"
              style="width: 80%"
            />
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      if (userId) {
        // 获取表详细信息
        PurchaseinboundLists(userId, this.addDateRange(this.queryParams)).then(
          (res) => {
...
<style src="./PurchaseWarehousingxgcss/index.css"></style>
