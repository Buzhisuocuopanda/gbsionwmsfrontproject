    ...
    <div class="filter-container prodtotal">
      <el-form :inline="true" style="height:auto;">
        ...
        <el-form-item label="销售订单号" style="margin-left: 10px" class="item-r">
          <el-input v-model="queryParams.saleOrderNo" style="margin-left: 10px;" class="filter-item"
            placeholder="销售订单号" />
        </el-form-item>
        <el-form-item label="仓库" v-if="false" style="margin-left: 20px" class="item-r">
          <el-select style="margin-left: 10px" v-model="queryParams.whId" clearable filterable remote reserve-keyword
        ...
        <el-form-item label="客户" v-if="false" style="margin-left: 20px;" class="item-r">
          <el-select v-model="queryParams.customerId" style="margin-left: 10px" clearable filterable
        ...
        <el-form-item>
          <el-button v-hasPermi="['query:fnSynthesisParts:list']" class="filter-item" type="primary"
          ...
          <el-button v-hasPermi="['query:fnSynthesisParts:export']" class="filter-item" type="primary"
      ...
      <el-table :header-cell-style="headClasspwfnsyns" :data="inwuquList" :row-style="{ height: '3px' }"
        ...
        v-loading="loading" border fit highlight-current-row stripe>
        <el-table-column v-if="false" fixed label="入库时间" align="left" :formatter="formatDate" header-align="center"
          prop="inWhTime" min-width="100px;" />
        ...
        <el-table-column label="数量" :formatter="rounding3" align="right" prop="qty" min-width="60px;" />
...
import { fnSynthesisParts, getSwJsStoreSkuAllList, getSwJsCustomerAllList } from "@/api/statisticAnalysis/index";
//
// import { formatDate } from '../../../utils';
export default {
  name: "FnSynthesisParts",
  data() {
    return {
      //下拉列表数据仓库
      storeSkuList: [],
  ...
  methods: {
    ...
    onSearch() {
      ...
      this.loading = true;
      fnSynthesisParts(this.queryParams).then(response => {
        this.loading = false;
