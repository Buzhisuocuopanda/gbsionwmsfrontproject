  ...
  <div>
    ...
    <div style="width: 90%; margin-left: 5%; margin-top: 1%; padding-bottom: 5%">
      ...
      <div v-if="edit == 0 || edit == 3">
        ...
        <el-table v-loading="loading" :data="userLists" height="250" border
        ...
        <el-table style="margin-top: 1%; width: 100%;" v-loading="loading" border :data="userList1"
        ...
        <el-table v-loading="loading" border :data="userListsss" style="width: 100%;"
          ...
          <el-table-column prop="sn" key="sn" align="" label="SN">
            <template slot-scope="scope" style="width: 200%">
              ...
              <el-select @change="updsteSn(scope.row,$event)" :disabled="scope.row.scanStatus=='已扫码'"
                v-model="scope.row.sn" style="width: 100%">
