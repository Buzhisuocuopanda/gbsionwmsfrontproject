<template>
  <div>
        ...
        <el-col style="margin-left: 2%;" :span="7">
          ...
          <el-form-item label="客户名称:" prop="cbpc0999">
            <el-popover placement="bottom-start" trigger="click" disabled>
              ...
              <el-input slot="reference" v-model="form2.cbpc0999" placeholder="" readonly style="width:85%;" disabled>
              </el-input>
            </el-popover>
          </el-form-item>
          <!-- </el-form-item> -->
        ...
        <el-col style="" :span="7">
          <el-form-item label="仓库:" prop="cbpc100">
            <el-popover placement="bottom-start" trigger="click" clearable disabled>
              ...
              <el-input slot="reference" v-model="form2.cbpc100" placeholder="" disabled style="width:85%;">
              </el-input>
            </el-popover>
          </el-form-item>
        </el-col>
        <el-col style="" :span="7">
          <el-form-item label="销售人员:" prop="cbsb177">
            <el-popover placement="bottom-start" trigger="click" clearable disabled>
              ...
              <el-input slot="reference" v-model="form2.cbsb177" placeholder="" readonly disabled style="width:85%;">
              </el-input>
            </el-popover>
          </el-form-item>
        </el-col>
    ...
    <div class="tinajia_dingwei" style="margin-left: 2%; left: 0;margin-top:3%">
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      console.log(this.form2, 5555, this.$route)
