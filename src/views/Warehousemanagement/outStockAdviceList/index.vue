  ...
  <div class="app-container outAdvicelist">
    ...
    <el-form ref="form" :model="queryParams" label-width="80px" inline>
      ...
      <el-form-item label="状态">
        <el-select style="width:150px;" v-model="queryParams.status" clearable filterable remote reserve-keyword
          placeholder="请选择">
      ...
      <el-form-item style="margin-left: 80px">
        ...
        <el-button v-hasPermi="['system:outStockAdviceList:list']" class="filter-item" type="primary"
    ...
    <el-table :row-style="{ height: '3px' }" :cell-style="{ padding: '2px' }" height="450" :header-cell-style="headClasspw"
      ...
      <el-table-column prop="qty" width="80px;" label="数量" :formatter="rounding" align="right" sortable>
      </el-table-column>
