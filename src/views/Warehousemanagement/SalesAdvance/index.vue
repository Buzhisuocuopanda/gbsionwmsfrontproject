    ...
    <div class="app-container">
        <el-row :gutter="20" style="margin-left:-10%;">
            ...
            <el-col :span="20" :xs="24" class="tooltup" style="width:100%;">
                ...
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                    ...
                    <el-form-item>
                         <el-button size="mini" class="biaoto-buttonchaxuen" v-hasPermi="['system:saleChange:list']" @click="handleQuery">查询</el-button>
                    </el-form-item>
                    <el-form-item>
                    ...
                    <el-form-item style="margin-left:70%;">
                        ...
                        <el-button size="mini" class="biaoto-buttonchuangjian" v-hasPermi="['system:saleChange:add']" @click="handleChuangJiangone">创建
                        </el-button>
                        <el-button type="mini" class="biaoto-buttonshanchu" v-hasPermi="['system:saleChange:remove']" :disabled="multiple" @click="handleDelete">
                            删除</el-button>
                ...
                <el-table border :header-cell-style="headClasspw" :row-style="{height: '3px'}" :cell-style="{padding: '2px'}"  v-loading="loading" :data="userList" height="430"
                    ...
                    <el-table-column label="编号" width="130px;" align="left" key="orderNo" :show-overflow-tooltip="true" prop="orderNo"
                        sortable />
                    ...
                    <el-table-column label="销售人员" align="left" key="caua17" prop="caua17" sortable />
                    ...
                    <el-table-column label="操作" align="center" width="240" class-name="small-padding fixed-width">
                        <template slot-scope="scope" style="margin-left:-10%;">
                            ...
                            <!-- <el-button size="mini" type="text" icon="el-icon-s-order" class="caozuoxiangqeng"
                                @click="PurchaseinboundFanShenpi(scope.row)" v-hasPermi="['system:saleChange:fs']"
                                v-if="scope.row.status == 1">反审</el-button>
                            <el-button size="mini" type="text" icon="el-icon-s-order" class="caozuoxiangqeng"
                                @click="PurchaseinboundQuxiaoWangcheng(scope.row)"
                                v-hasPermi="['system:saleChange:bjwc']" v-if="scope.row.status == 4">取消完成</el-button>
                            <el-button size="mini" type="text" icon="el-icon-s-order" class="caozuoxiangqeng"
                                @click="PurchaseinboundBiaojiWancheng(scope.row)"
                                v-hasPermi="['system:saleChange:qxwc']"
        ...
        <el-dialog :visible.sync="open">
            <div style="margin-top:-30px;">
                <span style="font-size:20px;">销售预订单变更单</span>
                <hr />
            </div>
            <el-form ref="form" :model="form" label-width="30%" style="margin-left:-15%;margin-top:3%;">
                ...
                <el-row>
                    ...
                    <el-col style="margin-top:1%;">
                        <el-form-item label="销售人员:" prop="cbpc16">
                    ...
                    <!-- <el-col style="margin-top:1%;">
                        <el-form-item label="商品名称:" prop="cbwa09">
                            <el-popover placement="bottom-start" trigger="click">
                ...
                <el-row v-if="false">
                    <el-col>
                        <el-form-item label="供应商id" prop="cbsa01">
...
import { PurchaseinboundAdd, PurchaseinboundList, PurchaseinboundEdit, PurchaseinboundRemove, PurchaseinboundSH, PurchaseinboundShs, Purchaseinbounds, PurchaseinboundShss, SupplierList, GoodsList01, StoreList, StoreSkuList, PurchaseinboundLists } from "@/api/Warehousemanagement/SalesAdvance";
import * as req from "@/api/Warehousemanagement/SalesAdvance";
...
export default {
    ...
    methods: {
        ...
        selected03(name) {
            console.log(name, 123)
            console.log(name.substring(name.indexOf("-") + 1), 963);
            this.form.supplierId = name.substring(name.indexOf("-") + 1);
            this.form.cbsa08 = name.substring(0, name.indexOf("-"));
            // this.form2.icon = name;
        },
        //添加行
        ...
        handleUpdate() {
                ...
                row.supplierId = this.form.supplierId;
                row.id = this.form.id;
        ...
        handlexiangqengSelect(row) {
            ...
            this.form.cbpc16 = row.caua17;
            this.form.cbsa08  = row.cbsa08 ;
            this.form.goodsclassify = row.goodsclassify;
            this.form.id = row.id;
